window.L_TOP_RANK_META_KEYWORDS = [];
{
...
window.L_SAME_TITLE_EXISTS = [];
{
	L_SAME_TITLE_EXISTS[C_US] = 'Same title exists';
}

window.L_SAME_VIDEO_EXISTS = [];
{
